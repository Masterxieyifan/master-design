...
<template>
    <div class="md-page-frame-example">
        ...
        >
            <md-module-card v-for="item in 10" :key="item" title="数据列表"></md-module-card>
        </md-page-frame>
    </div>
</template>
...
<script>
    const Tab1 = require('./components/PageFrameTab1.vue').default;
    const Tab2 = require('./components/PageFrameTab2.vue').default;
    export default {
        components: {
            Tab1,
            Tab2,
